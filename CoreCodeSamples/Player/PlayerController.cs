...
public class PlayerController : MonoBehaviour
{
    ...
    public void PlayerMove()
    {
        ...
        // Handle silent walking (slower movement)
        ...
        // Handle gravity and vertical movement (falling or jumping)
        if (!isGround)
        {
    ...
    {
        isJump = Input.GetButtonDown("Jump"); // Check if jump button is pressed
        if (isJump && isGround)
        {   
            audioList[1].Play();
